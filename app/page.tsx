					...
					>
						...
						<div className="grid gap-6">
								...
								<div className="flex items-start gap-4">
									...
									<div>
										<h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-3 text-lg">
											Recall Probability (R)
										</h3>
										<p className="text-gray-700 dark:text-gray-300 leading-relaxed">
											This measures how likely you are to
											solve a coding problem correctly on
											a given day, based on your past
											attempts and the time since your
											last review. It helps determine when
											you need to revisit a problem.
										</p>
									</div>
								</div>
							</div>
							...
							<div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-5 border-l-4 border-green-500">
								<div className="flex items-start gap-4">
									...
									<div>
										...
										<p className="text-gray-700 dark:text-gray-300 leading-relaxed">
											Half-life represents how long it
											takes for your ability to recall a
											problem to drop to a certain level
											(e.g., 90%). Repsheet aims to
											maximize this through optimal review
											timing.
										</p>
									</div>
								</div>
							...
							<div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-5 border-l-4 border-orange-500">
								<div className="flex items-start gap-4">
									<div className="bg-orange-500 rounded-full p-3 mt-1">
									...
									<div>
										...
										<p className="text-gray-700 dark:text-gray-300 leading-relaxed">
											Difficulty reflects how challenging
											a problem is for you. It increases
											if you mark a problem as "Hard" or
											fail to solve it, and decreases if
											you find it "Easy." Repsheet adjusts
											review schedules based on difficulty
